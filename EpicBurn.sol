 ...
 * 
 * Epic Burn token (EPB)
 * Manual burn 90% of totalSupply - Weekly 10%
 * 
 * In every transaction 10% devides to
 * 1% Redistribution
 * 5% Liquidity
 * 4% Auto burn
 * 
...
contract EPB is Context, IERC20, Ownable {
    ...
    string private _name = "EpicBurn";
    string private _symbol = "EPB";
